            ...
            <section class="section-shaped my-0">
                ...
                <div class="container shape-container d-flex">
                    <div class="col px-0">
                        <div class="row">
                            <div class="col-lg-6">
                                <h1 class="display-3  text-white">Design simplu
                                    <span>pentru Comenzi Online </span>
                                </h1>
                                <p class="lead  text-white">Platforma ofera functionalitati atat pentru angajatii Wetterbest cat si pentru clientii nostri</p>
